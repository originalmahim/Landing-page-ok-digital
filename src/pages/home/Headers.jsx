  ...
  return (
    <>
      <div id="about" className="mx-auto max-w-7xl">
        <div className="mx-auto flex w-full flex-col gap-16 bg-white/5 px-6 pt-6 ring-1 ring-white/10 sm:rounded-3xl lg:mx-0 lg:flex-row lg:items-center">
